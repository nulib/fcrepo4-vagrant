...
case $storagetype {
  'mysql':
  {
    ...
    class { '::fcrepo':
      ...
      fcrepo_repository_json => 'https://raw.githubusercontent.com/fcrepo4/fcrepo4/fcrepo-4.5.1-RC-3/fcrepo-configs/src/main/resources/config/minimal-default/repository.json',
      fcrepo_infinispan_xml  => 'https://raw.githubusercontent.com/fcrepo4/fcrepo4/fcrepo-4.5.1-RC-3/fcrepo-configs/src/main/resources/config/infinispan/jdbc-mysql/infinispan.xml',
      fcrepo_db_port      => '3306',
      #
      fcrepo_jgroups_fcrepo_tcp_xml => 'https://raw.githubusercontent.com/fcrepo4/fcrepo4/fcrepo-4.5.1-RC-3/fcrepo-configs/src/main/resources/config/jgroups-fcrepo-tcp.xml',
      ...
      fcrepo_warsource    => 'https://github.com/fcrepo4/fcrepo4/releases/download/fcrepo-4.5.1-RC-3/fcrepo-webapp-4.5.1-RC-3.war',
    }->
  ...
  'postgresql':
  {
    ...
    class { '::fcrepo':
      ...
      fcrepo_repository_json => 'https://raw.githubusercontent.com/fcrepo4/fcrepo4/fcrepo-4.5.1-RC-3/fcrepo-configs/src/main/resources/config/jdbc-postgresql/repository.json',
      fcrepo_infinispan_xml  => 'https://raw.githubusercontent.com/fcrepo4/fcrepo4/fcrepo-4.5.1-RC-3/fcrepo-configs/src/main/resources/config/infinispan/jdbc-postgresql/infinispan.xml',
      fcrepo_db_port      => '5432',
      #
      fcrepo_jgroups_fcrepo_tcp_xml => 'https://raw.githubusercontent.com/fcrepo4/fcrepo4/fcrepo-4.5.1-RC-3/fcrepo-configs/src/main/resources/config/jgroups-fcrepo-tcp.xml',
      fcrepo_db_host      => 'localhost',
  ...
  'leveldb':
  {
    ...
    class { '::fcrepo':
      ...
      fcrepo_repository_json => 'https://raw.githubusercontent.com/fcrepo4/fcrepo4/fcrepo-4.5.1-RC-3/fcrepo-configs/src/main/resources/config/minimal-default/repository.json',
      fcrepo_infinispan_xml  => 'https://raw.githubusercontent.com/fcrepo4/fcrepo4/fcrepo-4.5.1-RC-3/fcrepo-configs/src/main/resources/config/infinispan/leveldb-default/infinispan.xml',
      #
      fcrepo_jgroups_fcrepo_tcp_xml => 'https://raw.githubusercontent.com/fcrepo4/fcrepo4/fcrepo-4.5.1-RC-3/fcrepo-configs/src/main/resources/config/jgroups-fcrepo-tcp.xml',
      tomcat_source       => 'http://archive.apache.org/dist/tomcat/tomcat-7/v7.0.68/bin/apache-tomcat-7.0.68.tar.gz',
      fcrepo_warsource    => 'https://github.com/fcrepo4/fcrepo4/releases/download/fcrepo-4.5.1-RC-3/fcrepo-webapp-4.5.1-RC-3.war',
